...
(function($) {
    ...
    window.DependentLists = {
        ...
        init: function(options) {
            ...
            if(options.prefix)
            {
                list1Selector = '#' + options.prefix + '_' + options.list1;
                list2Selector = '#' + options.prefix + '_' + options.list2;
            }
            else{
                list1Selector = '#' + options.list1;
                list2Selector = '#' + options.list2;
            }
        ...
        setupDependency: function($list1, $list2, options) {
            ...
            if (options.list3) {
                var list3Selector;
                if(options.prefix)
                    list3Selector = '#' + options.prefix + '_' + options.list3;
                else
                    list3Selector = '#' + options.list3;
                $list3 = $(list3Selector);
