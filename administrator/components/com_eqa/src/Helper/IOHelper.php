...
abstract class IOHelper extends BaseIOHelper
{
	...
	static public function writeClassPam(Worksheet $sheet, object $classObject, array $classPam):void
	{
		...
		foreach ($classPam as $learner)
		{
			...
			$pam1 = $learner->pam1<0 ? SpecialMark::from($learner->pam1)->getLabel() : $learner->pam1;
			$pam2 = $learner->pam2<0 ? SpecialMark::from($learner->pam2)->getLabel() : $learner->pam2;
			$pam = $learner->pam<0 ? SpecialMark::from($learner->pam)->getLabel() : $learner->pam;
