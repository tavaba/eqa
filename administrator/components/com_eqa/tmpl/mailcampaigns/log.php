...
/**
 * Layout: log — Delivery log chi tiết của một campaign email
 *
 * Hiển thị:
 *   - Header: thông tin tóm tắt campaign (template, ngữ cảnh, tiến độ, trạng thái)
 *   - Bảng: danh sách queue items (người nhận, trạng thái, thời gian, lỗi)
 *
 * Biến từ HtmlView (qua $this->layoutData):
 *   $this->layoutData->campaign  object    — Thông tin campaign (đã enrich)
 *   $this->layoutData->items     object[]  — Danh sách queue items (đã preprocessing)
 *
 * Các field đã preprocessing trên campaign:
 *   status_label, status_badge, context_label, created_at_local (nếu có)
 *
 * Các field đã preprocessing trên mỗi queue item:
 *   status_html, last_attempt_at_local, sent_at_local, error_html
 *
...
/** @var \Kma\Component\Eqa\Administrator\View\Mailcampaigns\HtmlView $this */
