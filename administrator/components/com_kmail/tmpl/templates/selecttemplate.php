 ...
 *
 * Thuộc view 'templates' của com_kmail.
 * URL: index.php?option=com_kmail&view=templates&layout=selecttemplate
...
/** @var \Kma\Component\Kmail\Administrator\View\Templates\HtmlView $this */

$data             = $this->selectTemplateLayoutData;
...
$formAction = Route::_($data->notifyUrl, false);
...
<div class="container-fluid p-3">
    ...
    <!-- Form chọn template -->
    <form action="<?= $formAction ?>" method="post" id="adminForm">
