<?php
namespace Kma\Component\Kmail\Administrator\Base;

use Exception;
use Kma\Component\Kmail\Administrator\Enum\ObjectType;

class ListModel extends \Kma\Library\Kma\Model\ListModel
{
	/**
	...
	{
		$objectName = $this->englishService->pluralToSingular($this->getName());
